...
public class GuitarExercisesActivity extends ListActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			if (m_adapter == null) {
				...
				m_adapter = new GTutorAdapter(this, R.layout.list_chapters_ex,
						m_ListaElementi);
			}
			...
			lv.setOnItemClickListener(new OnItemClickListener() {
				public void onItemClick(AdapterView<?> parent, View view,
					...
					sImage = m_ListaElementi.get(position).m_sImage;
					sAudio = m_ListaElementi.get(position).m_sAudio;

					poIntent = new Intent(view.getContext(),
							ExerciseSelector.class);

					poIntent.putExtra("audio", sAudio);
					poIntent.putExtra("img", sImage);
