	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			intent = new Intent().setClass(this,
					it.puccetti.GuitarTutorFree.GuitarVideoSearcher.class);
			...
			/* SECONDO TAB */
			intent = new Intent().setClass(this,
					it.puccetti.GuitarTutorFree.GuitarLessonsActivity.class);
			...
			/* TERZO TAB */
			intent = new Intent().setClass(this,
					it.puccetti.GuitarTutorFree.GuitarExercisesActivity.class);
			spec = m_tabHost.newTabSpec("GuitarTutor").setIndicator("Esercizi",
					res.getDrawable(R.drawable.ic_tab_guitar_exercises))
					.setContent(intent);
			m_tabHost.addTab(spec);

			//Due tabs disabilitati
			/* QUARTO TAB */
			intent = new Intent().setClass(this,
					it.puccetti.GuitarTutorFree.GuitarExerciseDiaryActivity.class);
			...
			/* QUINTO TAB */
			intent = new Intent().setClass(this,
					it.puccetti.GuitarTutorFree.GuitarExerciseDiaryHistoryActivity.class);
