...
public class GuitarExerciseDiaryHistoryActivity extends ListActivity implements
		...
		try {
			...
			if (m_adapter == null) {
				...
				m_adapter = new GTutorAdapter(this,
						R.layout.list_chapters_diary_ex_history, m_ListaElementi);
			}
			...
			lv.setOnItemClickListener(new OnItemClickListener() {
				public void onItemClick(AdapterView<?> parent, View view,
					...
					poIntent = new Intent(view.getContext(),
							GuitarDiaryHistoryDetails.class);
